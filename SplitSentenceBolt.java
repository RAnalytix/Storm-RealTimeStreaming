...
public class SplitSentenceBolt extends BaseRichBolt{
	...
	public void execute(Tuple tuple) {
		try {
			...
			//final piece to Storm's reliability API is specifying when you've finished processing an individual tuple in the tuple tree
			//This is done by using the ack and fail methods on the OutputCollector.
			//In below line of code, the input tuple is acked after all the word tuples are emitted
